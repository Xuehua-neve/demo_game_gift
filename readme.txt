...
See https://zimjs.com/zapps/tool.html
...
You need to copy the code from the zapp.html to your app file (index.html)
as your index.html file will be listed in the service worker not the zapp.html file.
Once the code is copied you no longer need the zapp.html file.
NOTE: the app file must be an index.html file.
...
// and the call to the local custom script
    ...
    var filesToCache = [
      './',
      'index.html',
      'libraries/1.4.1/createjs.js',
      'libraries/017/zim.js',
      'scripts/custom.js',
      'assets/pic.png',
      'assets/sound.mp3',
      'assets/FFF.ttf'
...
NOTE: the PWA system to add to home screen 
currently works on iOS on Safari (not Chrome)
And on Android on all browsers.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
CONCLUSION 
Please join us at https://forum.zimjs.com or https://zimjs.com/discord 
